...
char PADDING16[256] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x0B, 0x9F, 0x2A, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0x00, 0xD6, 0x04, 0xF0, 0x09, 0x00, 0x00, 0x00,
    0x95, 0xC1, 0x5B, 0x0F, 0xF6, 0xFF, 0xFF, 0xFF,
    0xC0, 0x3B, 0x5B, 0x0F, 0xF6, 0xFF, 0xFF, 0xFF,
    0xB8, 0x55, 0x2C, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0x88, 0x3D, 0x2F, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0xE8, 0xE1, 0x2F, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0x98, 0x5A, 0x28, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0xC0, 0xB3, 0x77, 0x10, 0xF6, 0xFF, 0xFF, 0xFF,
    0x78, 0xEC, 0x2F, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
    0x88, 0x63, 0x2C, 0x7C, 0xFD, 0xFF, 0xFF, 0xFF,
...
- (void) applyChanges:(StatusBarOverrideData*)overrides {
    if (!StatusManager.sharedInstance.isMDCMode) {
        ...
        size_t s2 = fwrite (PADDING16, sizeof(PADDING16), 1, outfile);
