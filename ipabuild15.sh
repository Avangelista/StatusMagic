...
cd build
if [ -e "$APPLICATION_NAME-iOS-15.ipa" ]; then
rm "$APPLICATION_NAME-iOS-15.ipa"
fi
...
zip -vr "$APPLICATION_NAME-iOS-15.ipa" Payload
rm -rf $APPLICATION_NAME.app
rm -rf Payload
rm -rf DerivedData
mv "$APPLICATION_NAME-iOS-15.ipa" "../$APPLICATION_NAME-iOS-15.ipa"
cd ..
rm -rf build
